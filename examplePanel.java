...
class examplePanel extends JPanel implements ActionListener {
  ...
  public examplePanel(Color paramColor1, Color paramColor2, int paramInt) {
  ...
  public examplePanel(Color paramColor) {
    this.task = 1;
  ...
  public examplePanel(Stroke paramStroke, Color paramColor1, Color paramColor2) {
    this.task = 2;
  ...
  public examplePanel(StrokeAndColor paramStrokeAndColor, Color paramColor) {
